...
action :install do
  Chef::Log.info("This is my log message: (#{@current_resource.name}/#{@current_resource.version})")
  Chef::Log.info("The new resource/version: (#{@new_resource.name}/#{@new_resource.version})")
  ...
  Chef::Log.info("The install_version is(#{install_version})")
...
def candidate_version
  Chef::Log.info("The candidate version is(#{@candidate_version})")
